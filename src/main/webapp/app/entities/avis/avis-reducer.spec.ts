...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './avis.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AVIS_LIST actions', async () => {
    ...
    it('dispatches FETCH_AVIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AVIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AVIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AVIS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AVIS actions', async () => {
      const expectedActions = [
        {
