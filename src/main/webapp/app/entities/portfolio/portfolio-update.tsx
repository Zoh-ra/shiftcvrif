  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="cvthequeApp.portfolio.home.createOrEditLabel" data-cy="PortfolioCreateUpdateHeading">
            <Translate contentKey="cvthequeApp.portfolio.home.createOrEditLabel">Create or edit a Portfolio</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('cvthequeApp.portfolio.image')}
                id="portfolio-image"
                name="image"
                data-cy="image"
                type="text"
              />
              <ValidatedField label={translate('cvthequeApp.portfolio.lien')} id="portfolio-lien" name="lien" data-cy="lien" type="text" />
