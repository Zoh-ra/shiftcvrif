...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROGRAMMATION_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROGRAMMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROGRAMMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROGRAMMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROGRAMMATION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROGRAMMATION actions', async () => {
      const expectedActions = [
        {
