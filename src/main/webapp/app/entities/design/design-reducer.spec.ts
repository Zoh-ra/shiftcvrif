...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './design.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESIGN_LIST actions', async () => {
    ...
    it('dispatches FETCH_DESIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DESIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DESIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DESIGN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DESIGN actions', async () => {
      const expectedActions = [
        {
