...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './etude.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ETUDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ETUDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ETUDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ETUDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ETUDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ETUDE actions', async () => {
      const expectedActions = [
        {
