...
export const LangueDetail = (props: RouteComponentProps<{ id: string }>) => {
    ...
    <Row>
      <Col md="8">
        <h2 data-cy="langueDetailsHeading">
          <Translate contentKey="cvthequeApp.langue.detail.title">Langue</Translate>
        </h2>
