...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './outil.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_OUTIL_LIST actions', async () => {
    ...
    it('dispatches FETCH_OUTIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_OUTIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_OUTIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_OUTIL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_OUTIL actions', async () => {
      const expectedActions = [
        {
